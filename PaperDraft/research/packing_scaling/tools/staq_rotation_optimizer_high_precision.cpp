...
// It differs from src/tools/rotation_optimizer.cpp only by requesting 17-digit
// stream precision so OpenQASM round-trips do not accumulate 6-digit defaults.
#include <iomanip>
#include <iostream>
