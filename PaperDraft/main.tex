...
To make the price precise we formalize a downstream compiler---one positioned after randomization
...
obeys $\overline A_p+(2p-1)S\geq(1-\delta)m\log_2K_\epsilon-h_2(\delta)$,
...
J.Y. conceived the study, developed the theory and proofs, implemented the
compiler instrumentation and experimental pipeline, performed the majority
of the measurements and analyses, and wrote the manuscript.  Y.L. and
X.-H.D. carried out part of the measurements and analyses, supervised the
work, contributed to the framing and interpretation of the results, and
