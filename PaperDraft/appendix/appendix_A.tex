...
Define the $K$-representation gap of $C$ by
\[
\mathrm{Gap}^{K}_{\mathrm{rep}}(C)
:=
...
experimental; the formal lower bounds in the main text are the
budget-explicit output and cut-transcript theorems for the declared
finite-window stream model.
