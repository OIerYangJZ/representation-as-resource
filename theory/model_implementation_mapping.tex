...
The masked-share tracer writes the five restart fields after every update,
destroys the live Python state, and resumes from only those files, the committed
prefix, and unread input; its maximum is therefore an implementation of
$B_{\rm cut}$.  External compilers do not expose their private in-process DAGs,
