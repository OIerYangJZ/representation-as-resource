# SSH Environment Snapshot

Generated locally: `2026-07-06T11:37:40+00:00` UTC

## Source Note

- The SSH server did not contain a file named `ssh_environment_snapshot.md`.
- This local file combines the pulled `ssh_environment_setup.md` and `round3_environment_snapshot.md` so the requested filename exists in the extraction bundle.
...
Mode: `full`
Uniform timeout budget in this run: `600` seconds
Repository root: `/home/lyy/ucc_paper_round3`
...
- pyzx: `0.10.4`
- pytket: `2.18.0`
- pytket.extensions.qiskit: `available`
- ucc: `0.4.12`
- TKET passes: `FullPeepholeOptimise=True, PauliSimp=True, GuidedPauliSimp=True`
